...
export const PYQ_DATABASE: PYQQuestion[] = [
  ...
  },
  {
    ...
    correctOption: "B",
    explanation:
      "Statement 1 is correct: CBDC is legal tender and a direct liability of the Reserve Bank of India. Statement 2 is correct: Like physical cash tokens, CBDC can be held in self-custody digital wallets without needing an active commercial bank deposit account. Statement 3 is incorrect: CBDC is non-interest bearing to avoid disintermediation of commercial banks. Hence, only two statements are correct.",
    eliminationTechnique:
      "Remember the core monetary principle: If digital cash paid interest, citizens would withdraw all savings deposits from commercial banks to hold risk-free central bank cash, destabilizing credit creation. Thus statement 3 must be false.",
  },
  {
    ...
    correctOption: "D",
    explanation:
      "Namdapha National Park in Arunachal Pradesh has an altitudinal variation from 200m to over 4,500m in the Eastern Himalayas. Because of this massive altitudinal range, its climate transitions smoothly from Tropical (low-lying valleys) to Subtropical, Temperate, and Alpine/Arctic (snowy peaks).",
    eliminationTechnique:
      "Khangchendzonga and Nanda Devi are high-altitude parks that lack low-elevation tropical evergreen forest belts at their base.",
  },
  {
  ...
  },
  {
    ...
    correctOption: "A",
    explanation:
      "100 = 4 × 25 = 2² × 5². In the numerator: 85 has a factor of 5 (5 × 17), 95 has a factor of 5 (5 × 19). Together they provide 5 × 5 = 25. Also, 96 = 4 × 24, which provides a factor of 4. Since the numerator contains 25 × 4 = 100 as a factor, the entire product is an exact multiple of 100. Thus, the remainder is 0.",
    eliminationTechnique:
      "Always check for prime factor pairs of 10 (2 and 5) in product remainder questions.",
  },
  ...
  // --- MAINS PYQs ---
  {
    ...
    modelAnswerStructure: {
      introduction:
        "Constitutional morality refers to adherence to the core constitutional values, rule of law, democratic norms, and fundamental liberties, prioritizing institutional spirit over majoritarian impulse or popular morality.",
      ...
      diagramSuggestion:
        "A balance scale diagram showing 'Constitutional Morality (Rule of Law, Dignity, Pluralism)' outweighing 'Popular Morality / Majoritarian Sentiments'.",
      conclusion:
        "Constitutional morality acts as a beacon guiding the judiciary and executive to uphold pluralism, individual dignity, and democratic resilience in an evolving socio-political landscape.",
      recommendedKeywords: [
        "Dr. B.R. Ambedkar",
  ...
  },
  {
    ...
    questionText:
      "What is Digital Public Infrastructure (DPI)? Discuss how India Stack (Aadhaar, UPI, DigiLocker, ONDC) has accelerated financial and social inclusion.",
    marks: 15,
    wordLimit: 250,
    modelAnswerStructure: {
      introduction:
        "Digital Public Infrastructure (DPI) refers to interoperable, open, and scalable digital networks (identity, payment, and data exchange rails) built as public goods to deliver essential services to citizens at zero or low cost.",
      subheadingsAndPoints: [
        {
      ...
      diagramSuggestion:
        "A 3-layer architecture diagram: Layer 1 (Identity - Aadhaar), Layer 2 (Payments - UPI), Layer 3 (Data Exchange - Account Aggregator / DigiLocker) leading to 'Inclusive Growth'.",
      conclusion:
        "India's DPI represents a revolutionary shift from Silicon Valley's walled gardens to open democratic digital rails, transforming citizen welfare and positioning India as a global digital lighthouse.",
      recommendedKeywords: [
        "JAM Trinity",
  ...
  },
  {
    ...
    questionText:
      "What do you understand by the term 'Crisis of Conscience'? How does it manifest itself in the public domain and what are the ways to resolve it?",
    marks: 10,
    wordLimit: 150,
    modelAnswerStructure: {
      introduction:
        "'Crisis of Conscience' is an acute psychological and moral state of inner conflict when an individual's core ethical values, inner voice, and moral convictions are in sharp contradiction with external directives, official duties, or societal pressures.",
      subheadingsAndPoints: [
        {
      ...
      diagramSuggestion:
        "A triangular decision nexus: 'Legal Directives' vs 'Inner Moral Compass' vs 'Public Interest', resolved through 'Constitutional Morality'.",
      conclusion:
        "A civil servant must cultivate moral courage and emotional intelligence so that when a crisis of conscience strikes, public interest and constitutional righteousness triumph over expediency.",
      recommendedKeywords: [
        "Inner Voice",
        "Gandhian Talisman",
        "Nolan Principles",
