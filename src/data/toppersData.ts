...
export const TOPPERS_PROFILES: TopperProfile[] = [
  {
    ...
    quote:
      "Mains is all about smart presentation, precise micro-diagrams, and time management. Every half mark accumulated across 20 questions makes the difference between AIR 1 and missing the list.",
    keyStrategy:
      "Treated UPSC preparation as a structured engineering optimization problem. Focused heavily on PYQ reverse-engineering, creating concise 1-page notes for every syllabus keyword, and rigorous timed full-length test simulations.",
    gsStrategy: {
    ...
    essayStrategy:
      "Wrote multi-dimensional essays exploring Historical, Social, Economic, Political, Psychological, and Ethical angles (PESTLE + philosophical lens). Used catchy quotes in intro and closed with inspirational vision.",
    optionalStrategy:
      "Mastered electrical engineering fundamentals through rigorous numerical problem-solving and clean circuit diagrams. Practiced 10 years PYQs thrice.",
    prelimsStrategy:
      "Solved 60+ full length mock tests. Analyzed every incorrect option thoroughly. Maintained 90+ attempts with a calculated intelligent elimination approach.",
    csatStrategy:
      "Practiced 30 minutes daily from January onwards. Prioritized high-accuracy reading comprehension and quant problem patterns.",
    interviewScore: 200,
    mainsScore: 899,
    goldenRules: [
  ...
  },
  {
    ...
    quote:
      "Failures are simply data points showing where to refine your technique. After two prelims failures, fixing my active recall and mock test feedback loop changed everything.",
    keyStrategy:
      "Strong focus on PSIR interlinkages with GS2. Used current affairs extensively to substantiate theoretical concepts. Dedicated last 75 days before Prelims exclusively to MCQ testing and revision cycles.",
    gsStrategy: {
    ...
    essayStrategy:
      "Brainstormed for 15-20 minutes before penning down the essay. Balanced flow between prose, philosophical depth, and contemporary governance initiatives.",
    optionalStrategy:
      "For PSIR, connected Western & Indian Political Thinkers directly with contemporary global geopolitical dynamics (e.g. Morgenthau with Indo-Pacific tensions).",
    prelimsStrategy:
      "Maintained a dedicated 'Mistake Notebook'. Reviewed every silly mistake 24 hours before subsequent tests.",
    csatStrategy:
      "Mastered reading comprehension tone analysis and quick arithmetic elimination.",
    interviewScore: 193,
    mainsScore: 901,
    goldenRules: [
  ...
  },
  {
    ...
    quote:
      "Own your notes. Making your own consolidated handwritten notes provides an unmatched mental index during the intense 3-hour Mains papers.",
    keyStrategy:
      "Prepared self-made digital and handwritten notes directly aligned with UPSC syllabus headings. Extensive answer writing practice at Jamia RCA, focusing on clarity, structure, and subheadings.",
    gsStrategy: {
    ...
    essayStrategy:
      "Addressed philosophical topics through varied lenses: individual, societal, administrative, national, and global.",
    optionalStrategy:
      "History optional requires historiography, archaeological evidence, and high-quality historical site maps.",
    prelimsStrategy:
      "Solved previous 15 years UPSC Prelims papers multiple times to decode UPSC's question drafting mindset.",
    csatStrategy:
      "Regular practice of English comprehension and logical syllogisms.",
    interviewScore: 173,
    mainsScore: 932,
    goldenRules: [
  ...
  },
  {
    ...
    quote:
      "Stick to the basics and optimize your optional. Anthropology diagrams and case studies gave me the decisive scoring edge.",
    keyStrategy:
      "High scoring in Optional (320+) and GS3/GS4. Mastered fast diagramming techniques in Mains, completing every single paper on time.",
    gsStrategy: {
    ...
    essayStrategy:
      "Structured essays with catchy thematic titles, real stories from rural India, and concrete policy recommendations.",
    optionalStrategy:
      "Prepared over 150 biological and socio-cultural anthropology diagrams that could be drawn in under 45 seconds.",
    prelimsStrategy:
      "Practiced 75+ mocks. Focused heavily on high-weightage pillars (Polity, Modern History, Economy, Environment).",
    csatStrategy:
      "Strong focus on quant speed techniques and data interpretation.",
    interviewScore: 176,
    mainsScore: 878,
    goldenRules: [
  ...
  },
  {
    ...
    quote:
      "Objectivity is the key to UPSC Mains. Write what is asked, not what you know. Keep sentences short, data-backed, and use flowcharts whenever possible to save time.",
    keyStrategy:
      "Scored massively in Mathematics Optional (361/500). Prepared digitally using Evernote and OneNote, categorizing notes strictly by the UPSC syllabus keywords. Focused completely on high return on investment subjects like Ethics, Essay, and Optional.",
    gsStrategy: {
    ...
    essayStrategy:
      "Brainstormed for 25 minutes before starting. Focused on logical flow, transitions between paragraphs, and maintaining a balanced, optimistic tone throughout.",
    optionalStrategy:
      "Mathematics demands absolute rigor. Solved 15-20 years of PYQs. Made formula sheets for quick revision and practiced under strict time constraints to avoid calculation errors.",
    prelimsStrategy:
      "Did not over-read. Limited sources but revised them 5-6 times. Solved around 50 mock tests to develop the intuition for intelligent guessing and elimination.",
    csatStrategy:
      "Being from a math background, relied on natural aptitude but still practiced a few PYQs to stay in touch with the UPSC question phrasing.",
    interviewScore: 179,
    mainsScore: 942,
    goldenRules: [
...
export const TOPPER_BOOKS: BookItem[] = [
  // Prelims GS1 / Mains GS1
  {
    ...
    tipsForReading:
      "Read at least 5-6 times. On first read, read like a novel. On second read, highlight articles and exceptions. Make tables for comparing President vs Governor, Lok Sabha vs Rajya Sabha.",
    status: "reading",
  },
  {
    id: "history-spectrum",
    ...
    keyChapters: [
      "1857 Revolt & Socio-Religious Reforms",
      "National Movement (1905-1919)",
      "Gandhian Era (1919-1947)",
      "Governor Generals & Constitutional Acts",
      "Appendices & Personalities tables",
    ],
    tipsForReading:
      "Pay special attention to the summary tables at the end of each chapter. Connect dates with socio-economic causes.",
    status: "not_started",
  },
  {
    ...
    keyChapters: [
      "Money, Banking & Monetary Policy (Pillar 1)",
      "Fiscal Policy, Budget & Taxation (Pillar 2)",
      "International Trade, BoP, Forex (Pillar 3)",
      "Sectors of Economy & Agriculture (Pillar 4)",
      "Human Development & Infrastructure",
    ],
    tipsForReading:
      "Focus on conceptual clarity of inflation, repo rate, bond yields, and balance of payments. Supplement with latest Budget & Economic Survey summaries.",
    status: "not_started",
  },
  {
    ...
    keyChapters: [
      "Ecology Principles & Biogeochemical Cycles",
      "Biodiversity, IUCN Red List & Protected Areas",
      "Climate Change, UNFCCC COP summits & IPCC reports",
      "Environmental Laws (WPA 1972, EPA 1986, Biological Diversity Act)",
      "Pollution & Renewable Energy",
    ],
    tipsForReading:
      "Prepare maps of National Parks, Biosphere Reserves, Ramsar Wetlands, and Tiger Reserves. Memorize IUCN status of critically endangered Indian species.",
    status: "not_started",
  },
  {
    ...
    authorOrPublication:
      "NCERT (Fundamentals of Physical Geography) & G.C. Leong",
    subject: "Geography",
    paper: "Prelims GS1",
    priority: "Must Read / Core",
    ...
    keyChapters: [
      ...
      "Climatology (Monsoon, Cyclones, Jet Streams)",
      "Oceanography (Currents, Tides, Salinity)",
      "Indian Drainage System & River Basins",
      "Resources & Industrial Locations",
    ],
    tipsForReading:
      "Geography is 100% conceptual. Draw diagrams for every landform and atmospheric phenomenon. Use Oxford Student Atlas daily.",
    status: "not_started",
  },
  {
    ...
    keyChapters: [
      ...
      "Buddhism & Jainism Architecture & Philosophy",
      "Classical & Folk Dances, Music traditions",
      "Bhakti & Sufi Movements",
      "Puppetry, UNESCO Heritage Sites & Handlooms",
    ],
    tipsForReading:
      "Focus on NCERT Class 11 Fine Arts first (covers 70% of questions). Use Singhania for selective tables and diagrams.",
    status: "not_started",
  },
  {
    id: "ethics-lexicon",
    ...
    keyChapters: [
      "Ethics & Human Interface, Essence & Determinants",
      "Human Values & Role of Family/Society",
      "Attitude, Moral & Political Attitudes",
      "Emotional Intelligence in Governance",
      "Probity in Governance & RTI Act",
      "Case Study Methodologies",
    ],
    tipsForReading:
      "Prepare personal definitions for 30 key ethical terms. Build a template for solving case studies with 6 distinct steps.",
    status: "not_started",
  },
  {
    id: "csat-pyq-arihant",
    ...
    keyChapters: [
      "Reading Comprehension (Assumptions, Inferences, Main Idea)",
    ...
    tipsForReading:
      "CSAT has become the eliminator paper. Practice 30 questions weekly under strict 1-minute timer.",
    status: "not_started",
  },
];
...
export const TOPPER_ROUTINES: TopperRoutine[] = [
  {
    ...
    schedule: [
      {
        time: "06:00 - 06:30 AM",
        activity: "Wake up, Hydration, Light Exercise / Yoga",
        category: "Break / Health",
        description:
          "Oxygenates the brain, prepares mental focus for high-load morning session.",
      },
      {
        time: "06:30 - 09:00 AM",
        activity: "Slot 1: Heavy Static GS (Polity / Economy / History)",
        category: "GS",
        description:
          "2.5 hours of intense, uninterrupted conceptual reading when cognitive stamina is at peak.",
      },
      {
        time: "09:00 - 09:45 AM",
        activity: "Nutritious Breakfast & Break",
        category: "Break / Health",
        description: "Healthy protein breakfast without screens.",
      },
      {
        time: "09:45 - 11:45 AM",
        activity: "Slot 2: Newspaper (The Hindu / IE) + Editorial Notes",
        category: "Current Affairs",
        description:
          "2 hours analyzing editorials, issue-based mapping to syllabus topics.",
      },
      {
        time: "11:45 - 01:45 PM",
        activity: "Slot 3: Optional Subject (Paper 1 / Paper 2)",
        category: "Optional",
        description:
          "2 hours dedicated to Optional theory, PYQ mapping and thinker integration.",
      },
      {
        time: "01:45 - 02:45 PM",
        activity: "Lunch & 20-min Power Nap",
        category: "Break / Health",
        description: "Resets afternoon alertness.",
      },
      {
        time: "02:45 - 04:30 PM",
        activity: "Slot 4: Optional Notes / Numerical / Diagrams",
        category: "Optional",
        description: "1.75 hours consolidations and micro-diagram practice.",
      },
      {
        time: "04:30 - 05:00 PM",
        activity: "Tea break & Quick Walk",
        category: "Break / Health",
        description: "Physical break to prevent eye strain.",
      },
      {
        time: "05:00 - 06:30 PM",
        activity: "Slot 5: CSAT / Prelims 30 MCQs Practice",
        category: "CSAT / Revision",
        description: "Active recall testing with negative marks calculation.",
      },
      {
        time: "06:30 - 08:00 PM",
        activity: "Slot 6: Mains Answer Writing (2 GS + 1 Optional Question)",
        category: "Answer Writing",
        description:
          "Strict 7-min and 11-min timed answer writing with peer/mentor evaluation.",
      },
      {
        time: "08:00 - 09:00 PM",
        activity: "Dinner & Family Time",
        category: "Break / Health",
        description: "Social connection and relaxation.",
      },
      {
        time: "09:00 - 10:30 PM",
        activity: "Slot 7: Spaced Revision of Day's Topics + Plan Next Day",
        category: "CSAT / Revision",
        description:
          "1.5 hours reviewing day's notes so retention jumps to 80%.",
      },
      {
        time: "10:30 - 11:00 PM",
        activity: "Wind Down & Sleep",
        category: "Break / Health",
        description: "7 hours of restorative sleep.",
      },
    ],
    tips: [
  ...
  },
  {
    ...
    topperRef:
      "Anudeep Durishetty (IRS to IAS Rank 1) & Aditya Srivastava (IPS to IAS)",
    totalStudyHours: 5.5,
    wakeUpTime: "05:15 AM",
    sleepTime: "11:15 PM",
    schedule: [
      {
        time: "05:30 - 08:00 AM",
        activity: "Slot 1 (Pre-Office): Deep Static GS / Optional",
        category: "GS",
        description:
          "2.5 hours of golden undisturbed morning study before workday begins.",
      },
      {
        time: "08:00 - 09:00 AM",
        activity: "Commute / Breakfast: Audio Current Affairs / Podcasts",
        category: "Current Affairs",
        description:
          "Listen to Sansad TV / All India Radio discussions during travel.",
      },
      {
        time: "01:00 - 01:45 PM",
        activity: "Office Lunch Break: Digital Newspaper Editorials",
        category: "Current Affairs",
        description:
          "45 mins reading The Hindu / Indian Express on tablet/laptop.",
      },
      {
        time: "07:30 - 09:30 PM",
        activity: "Slot 2 (Post-Office): Optional Subject / Answer Writing",
        category: "Optional",
        description: "2 hours high-intensity study.",
      },
      {
        time: "09:30 - 10:15 PM",
        activity: "Dinner & Refreshment",
        category: "Break / Health",
        description: "Relaxation with family.",
      },
      {
        time: "10:15 - 11:15 PM",
        activity: "Slot 3: Daily MCQs / Spaced Revision",
        category: "CSAT / Revision",
        description: "1 hour quick-fire 25 MCQs and revision before bed.",
      },
      {
        time: "Weekends (Sat & Sun)",
        activity: "10-Hour Supercharge Weekend Sprints",
        category: "GS",
        description:
          "Catch up on full-length mock tests, essay writing, and weekly revision.",
      },
    ],
    tips: [
  ...
  },
  {
    ...
    schedule: [
      {
        time: "07:00 - 09:00 AM",
        activity: "Subject 1 Fast Revision (Polity / Economy / Env)",
        category: "GS",
        description: "High-speed notes flipping with active recall.",
      },
      {
        time: "09:30 - 11:30 AM",
        activity: "Full Length Prelims Mock Test (GS Paper 1)",
        category: "CSAT / Revision",
        description:
          "Strictly simulated 2-hour exam under real conditions with OMR sheet.",
      },
      {
        time: "11:45 - 01:45 PM",
        activity: "Mock Test In-Depth 360° Post-Mortem",
        category: "CSAT / Revision",
        description:
          "Analyze every incorrect question and identify knowledge gap vs silly mistake.",
      },
      {
        time: "02:30 - 04:30 PM",
        activity: "CSAT Full Length Mock Test / Quant-Logic Sprint",
        category: "CSAT / Revision",
        description:
          "Simulating CSAT during actual 2:30 PM exam slot to train circadian rhythm.",
      },
      {
        time: "05:00 - 07:30 PM",
        activity: "Yearly Current Affairs Compilation (PT 365 / Annual Digest)",
        category: "Current Affairs",
        description: "Mapped to environment, sci-tech, and government schemes.",
      },
      {
        time: "08:30 - 10:30 PM",
        activity: "UPSC 10-Year PYQ Option Elimination Practice",
        category: "CSAT / Revision",
        description: "Mastering UPSC question patterns and intuition.",
      },
      {
        time: "10:30 - 11:30 PM",
        activity: "Mistake Diary Review",
        category: "CSAT / Revision",
        description: "Reading only your personal mistake notebook.",
      },
    ],
    tips: [
...
export const TOPPER_INTERVIEWS: InterviewTranscript[] = [
  {
    ...
    dafHighlights: [
      "IIT Kanpur Electrical Engg",
      "Goldman Sachs work experience",
      "IPS Training at SVPNPA Hyderabad",
      "Swimming & Reading non-fiction",
    ],
    qaExcerpts: [
      {
        question:
          "You are already in the Indian Police Service (IPS). Why do you want to switch to the Indian Administrative Service (IAS)? Isn't IPS impactful enough?",
        askedBy: "Chairperson",
        answer:
          "Sir, IPS provides an unparalleled opportunity to enforce the rule of law, internal security, and direct citizen protection. However, IAS provides a broader multi-sectoral platform spanning policy formulation in health, education, infrastructure, and rural development. My technical background in engineering and administrative training in IPS will synergistically allow me to contribute across broader socio-economic domains.",
        analysis:
          "Balanced, highly respectful to IPS, highlighted synergy rather than downplaying the current service.",
      },
      {
        question:
          "As an electrical engineer, how would you address India's DISCOM debt crisis without compromising green energy transition targets?",
        askedBy: "Member 1 (Technical)",
        answer:
          "Sir, the DISCOM crisis is structural (AT&C losses, delayed subsidy payouts, and under-cost tariffs). The solution requires: 1) 100% smart prepaid metering under RDSS scheme to plug billing leakages; 2) Enforcing Cost-Reflective Tariffs with direct benefit transfer (DBT) of power subsidies; 3) Grid-scale battery energy storage systems (BESS) to integrate intermittent renewables without grid collapse.",
        analysis:
          "Structured, technical yet administrative, directly cited schemes (RDSS) and actionable fixes.",
      },
      {
        question:
          "What is your stance on the regulation of Generative AI in governance? Should India adopt an EU-style strict regulatory model or an innovation-first US model?",
        askedBy: "Member 3",
        answer:
          "India should adopt a hybrid 'Risk-Based Light-Touch' regulatory approach. For critical public services like healthcare diagnostics, biometric identity, and law enforcement, strict algorithmic auditing and data privacy (DPDP Act) are essential. For commercial innovation and MSMEs, regulatory sandboxes should allow fast prototyping without strangling growth.",
        analysis:
          "Nuanced, avoided extreme black-and-white positions, linked to Indian statutory context (DPDP Act).",
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    dafHighlights: [
      "SRCC Economics Graduate",
      "Subroto Cup Football Player",
      "PSIR Optional",
    ...
    qaExcerpts: [
      {
        question:
          "You played national-level football. What leadership lessons from the football field apply directly to managing a district as a District Magistrate?",
        askedBy: "Chairperson",
        answer:
        ...
        analysis:
          "Deeply authentic, linked physical sport to district administration hierarchy seamlessly.",
      },
      {
        question:
          "India's female labor force participation rate (FLFPR) has seen challenges. As an economist and administrator, what single intervention would you prioritize?",
        askedBy: "Member 2 (Economic)",
        answer:
          "While skilling and maternity benefits are crucial, the single most transformative intervention is providing safe, reliable, and subsidized public transportation and care infrastructure (creches). Women's mobility directly determines their access to formal sector jobs and educational hubs.",
        analysis:
          "Identified a structural root enabler (mobility & care economy) rather than generic platitudes.",
      },
    ],
    keyTakeaways: [
