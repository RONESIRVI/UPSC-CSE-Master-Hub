...
export const DEFAULT_SYLLABUS: SyllabusTopic[] = [
  // --- PRELIMS GS1 ---
  {
    ...
    status: "in_progress",
    notes:
      "Revise Article 14-32 exceptions and Kesavananda basic structure test.",
    subtopics: [
  ...
  },
  {
    ...
    title:
      "Indus Valley, Vedic Age, Mauryan/Gupta Empires, Delhi Sultanate & Mughals",
    yield: "⭐ Medium Yield",
    weightagePercentage: 6.5,
    pyqFrequencyLast5Years: 11,
    status: "not_started",
    notes:
      "Terms used for land revenue, administrative posts, and foreign travelers.",
    subtopics: [
  ...
  },
  {
    ...
    status: "not_started",
    notes:
      "Bond yield relationships, Repo/Reverse Repo mechanics, and CAD dynamics.",
    subtopics: [
  ...
  },
  {
    ...
    status: "not_started",
    notes:
      "National Parks along river basins, Tiger corridors, and Biosphere zonation.",
    subtopics: [
  ...
  },
  {
    ...
    title:
      "Geomorphology, Climatology, Oceanography & Indian Physical Features",
    yield: "⭐ Medium Yield",
    weightagePercentage: 9.0,
    pyqFrequencyLast5Years: 16,
    status: "not_started",
    notes:
      "Map plotting of major straits, mountain passes, and river tributaries.",
    subtopics: [
  ...
  },
  {
    ...
    status: "not_started",
    notes:
      "CSAT requires 33% (66 marks out of 200). Practice high-yield topics first.",
    subtopics: [
  ...
  },
  {
    ...
    status: "not_started",
    notes:
      "Beware of extreme words: 'only', 'never', 'solely', 'drastic reduction'.",
    subtopics: [
  ...
  // --- MAINS GS PAPERS ---
  {
    ...
    title:
      "Salient Aspects of Art & Architecture, Diversity of India, Women's Issues & Urbanization",
    yield: "⭐ Medium Yield",
    weightagePercentage: 35.0,
    pyqFrequencyLast5Years: 12,
    status: "not_started",
    notes:
      "Link societal challenges with NFHS-5, Census and sociological perspectives.",
    subtopics: [
  ...
  },
  {
    ...
    title:
      "Federalism, Separation of Powers, Welfare Schemes, Citizen Charters & International Relations",
    yield: "🔥 High Yield",
    weightagePercentage: 100.0,
    pyqFrequencyLast5Years: 20,
    status: "not_started",
    notes:
      "Always quote Supreme Court verdicts, 2nd ARC and Law Commission recommendations.",
    subtopics: [
  ...
  },
  {
    ...
    title:
      "Inclusive Growth, Agriculture Subsidies, Cyber Security, Border Management & Disaster Response",
    yield: "🔥 High Yield",
    weightagePercentage: 100.0,
    pyqFrequencyLast5Years: 20,
    status: "not_started",
    notes:
      "Utilize NITI Aayog documents, economic diagrams, and disaster management flowcharts.",
    subtopics: [
  ...
  },
  {
    ...
    title:
      "Ethics in Human Action, Emotional Intelligence, Moral Thinkers, Probity & Case Studies",
    yield: "🔥 High Yield",
    weightagePercentage: 100.0,
    pyqFrequencyLast5Years: 20,
    status: "not_started",
    notes:
      "Prepare 50 real civil service examples and standard 7-step case study approach.",
    subtopics: [
...
export const DEFAULT_STUDY_PLAN_PHASES: StudyPlanPhase[] = [
  {
    ...
    focusArea:
      "NCERT Class 6-12 basics + Core static conceptual reading + Newspaper habit",
    status: "completed",
    milestones: [
      {
        id: "m1",
        title: "Complete NCERT Class 9-12 for Geography & Polity",
      ...
      },
      {
        id: "m2",
        title:
          "Finish Class 11 Fine Arts & Spectrum Modern History (1st Reading)",
      ...
      },
      {
        id: "m3",
        title:
          "Establish daily 2-hour newspaper and editorial note-making habit",
  ...
  },
  {
    ...
    focusArea:
      "Polity (Laxmikanth), Economy (Mrunal/Singhania), Environment (PMF), and 100% Optional Paper 1 & 2",
    status: "in_progress",
    milestones: [
      {
        id: "m4",
        title: "Complete M. Laxmikanth with personal tables & article index",
        targetDate: "2026-09-30",
        completed: true,
      },
      {
        id: "m5",
        title: "Finish Optional Subject Paper 1 syllabus & prepare short notes",
        targetDate: "2026-10-31",
        completed: true,
      },
      {
        id: "m6",
        title: "Finish Indian Economy concepts + Environment core modules",
        targetDate: "2026-11-30",
        completed: false,
      },
      {
        id: "m7",
        title: "Finish Optional Paper 2 and solve 5 years PYQs",
  ...
  },
  {
    ...
    focusArea:
      "Ethics Lexicon + 50 Case studies + GS2/GS3 value addition + Daily 2-answer writing",
    status: "upcoming",
    milestones: [
      {
        id: "m8",
        title:
          "Master GS4 Ethics definitions, thinkers, and write 30 case studies",
        targetDate: "2027-01-31",
        completed: false,
      },
      {
        id: "m9",
        title: "Create 1-page cheatsheets for all GS2 & GS3 micro-topics",
        targetDate: "2027-02-15",
        completed: false,
      },
      {
        id: "m10",
        title: "Write 6 full-length GS sectional tests with peer evaluation",
  ...
  },
  {
    ...
    focusArea:
      "45 Full Prelims Mocks + 20 CSAT Mocks + PT 365 Yearly Compilations + Spaced Revision",
    status: "upcoming",
    milestones: [
      {
        id: "m11",
        title:
          "Solve 10 years UPSC Prelims PYQs twice with option elimination notes",
      ...
      },
      {
        id: "m12",
        title:
          "Achieve consistent 100+ score in GS1 and 80+ in CSAT full tests",
      ...
      },
      {
        id: "m13",
        title:
          "3 rounds of static revision (Polity, Economy, Env, History, Geo)",
