...
export const DEFAULT_MOCKS: MockTestLog[] = [
  {
    ...
    accuracyRate: 59.1,
    analysisNotes:
      "Too many negative marks (-24 marks loss) due to wild guesses in Ancient History & Science Tech. Polity & Economy accuracy was 82%.",
  },
  {
    id: "mock-2",
    ...
    accuracyRate: 68.3,
    analysisNotes:
      "Disciplined elimination technique improved score. Environment National Parks need map revision.",
  },
  {
    id: "mock-3",
    ...
    accuracyRate: 73.3,
    analysisNotes:
      "Close to danger line for CSAT! Spent too much time on long Permutation questions. Reading Comprehension accuracy was good (85%).",
  },
];
...
export const DEFAULT_WEAK_AREAS: WeakAreaItem[] = [
  {
    ...
    severity: "Critical",
    rootCause:
      "Spending 4+ minutes per problem without quick formula application. Low accuracy (45%) on remainder theorem questions.",
    recommendedAction:
      "Practice 15 number system questions daily with timer. Focus on unit digits and divisibility shortcuts.",
  ...
  },
  {
    ...
    severity: "Critical",
    rootCause:
      "Confusion between rivers flowing through Corbett vs Kaziranga vs Namdapha. UPSC asks exact spatial questions.",
    recommendedAction:
      "Plot all 106 National Parks on state blank maps with key flora/fauna and major river tributaries.",
  ...
  },
  {
    ...
    severity: "Moderate",
    rootCause:
      "Taking 20+ minutes per case study instead of 14 minutes, leaving last 2 questions rushed.",
    recommendedAction:
      "Adopt the 7-step standardized template: Stakeholders -> Dilemmas -> 3 Options Evaluation -> Justification -> Prevention.",
  ...
  },
  {
    ...
    severity: "Moderate",
    rootCause:
      "Conceptual confusion when rupee depreciates vs real effective exchange rate (REER).",
    recommendedAction:
      "Revisit Mrunal Pillar 3 notes and draw currency flow diagrams.",
  ...
  },
  {
    ...
    topic:
      "Pardoning Powers & Discretionary Jurisdictions (Governor vs President)",
    paper: "Prelims GS1",
    severity: "Moderate",
    rootCause:
      "Mixing up Article 72 and Article 161 nuances regarding court martial and death sentences.",
    recommendedAction:
      "Create a side-by-side comparative table and solve 15 targeted MCQs on constitutional heads.",
  ...
  },
  {
    ...
    severity: "Critical",
    rootCause:
      "Lack of clarity on recombinant DNA technology vs mitochondrial replacement therapy mechanisms.",
    recommendedAction:
      "Watch 3D animation breakdowns and summarize 5 recent Nobel discoveries in S&T.",
  ...
  },
  {
    ...
    severity: "Minor",
    rootCause:
      "Remembering specific sub-schools (Khajuraho, Solanki, Kalinga) shikhara differences.",
    recommendedAction:
      "Draw ground plans and elevation sketches of standard Nagara and Dravida temples.",
  ...
  },
  {
    ...
    severity: "Moderate",
    rootCause:
      "Correlating Walker Circulation, ENSO and Indian Ocean Dipole (IOD) phases with monsoon troughs.",
    recommendedAction:
      "Draw schematic atmospheric cross-sections of positive vs negative IOD.",
...
export const DEFAULT_GAP_ANALYSIS: TimeVsWeightageGap[] = [
  {
    ...
    gapStatus: "Balanced",
    recommendation:
      "Optimal investment. Maintain weekly revision and article recall tests.",
    actionAdvice:
      "Optimal investment. Maintain weekly revision and article recall tests.",
  },
  {
    ...
    recommendation:
      "DANGER: Environment accounts for 18% of UPSC marks (~35-40 marks) but only 8.5% of your study time. Increase daily allocation by +1 hour.",
    actionAdvice:
      "DANGER: Environment accounts for 18% of UPSC marks (~35-40 marks) but only 8.5% of your study time. Increase daily allocation by +1 hour.",
  },
  {
    ...
    recommendation:
      "CAUTION: Spending too much time memorizing low-yield dynasties. Cap reading to NCERT Class 11 Fine Arts and shift time to Economy & Environment.",
    actionAdvice:
      "CAUTION: Spending too much time memorizing low-yield dynasties. Cap reading to NCERT Class 11 Fine Arts and shift time to Economy & Environment.",
  },
  {
    ...
    gapStatus: "Under-investing (High Risk)",
    recommendation:
      "CRITICAL: Thousands of top GS scorers fail UPSC solely due to CSAT. Dedicate minimum 45 minutes daily to quant and reasoning.",
    actionAdvice:
      "CRITICAL: Thousands of top GS scorers fail UPSC solely due to CSAT. Dedicate minimum 45 minutes daily to quant and reasoning.",
  },
  {
    ...
    gapStatus: "Balanced",
    recommendation:
      "Good pacing. Link static concepts with upcoming Economic Survey & Budget highlights.",
    actionAdvice:
      "Good pacing. Link static concepts with upcoming Economic Survey & Budget highlights.",
  },
];
...
export const DEFAULT_REVISION_QUEUE: RevisionItem[] = [
  {
    ...
    flashcardQuestions: [
      {
        q: "Can freedom of speech be restricted on grounds of 'public interest' under Article 19(2)?",
        a: "No! 'Public interest' is not a grounds under 19(2); only 'Public order' is specified (which has a higher threshold).",
      },
      {
        q: "Which constitutional amendment added 'friendly relations with foreign states' and 'incitement to an offence' to 19(2)?",
        a: "First Constitutional Amendment Act, 1951.",
      },
    ],
  },
  {
    ...
    flashcardQuestions: [
      {
        q: "Which two Indian wetlands are currently in the Montreux Record?",
        a: "Keoladeo National Park (Rajasthan) and Loktak Lake (Manipur).",
      },
      {
        q: "What is the largest Ramsar site in India?",
        a: "Sundarbans Wetland in West Bengal.",
      },
    ],
  },
  {
    ...
    topicTitle:
      "Monetary Policy Transmission & Standing Deposit Facility (SDF)",
    subject: "Indian Economy",
    paper: "Prelims GS1",
    ...
    flashcardQuestions: [
      {
        q: "Does RBI provide collateral G-Secs under Standing Deposit Facility (SDF)?",
        a: "No! SDF is a collateral-free liquidity absorption tool under Section 17 of RBI Act.",
      },
      {
        q: "What constitutes the upper ceiling and lower floor of the Monetary Policy LAF corridor?",
        a: "Upper Ceiling: MSF rate; Middle Anchor: Policy Repo rate; Lower Floor: SDF rate.",
      },
    ],
  },
];
