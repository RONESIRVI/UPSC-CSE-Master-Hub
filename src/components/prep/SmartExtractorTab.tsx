          ...
          <div className="flex-1 overflow-y-auto p-4 bg-slate-50/30">
            {!uploadedImage ? (
              ...
              <div className="space-y-4 h-full flex flex-col">
                <textarea 
                  className="w-full flex-1 bg-white border border-slate-200 rounded-xl p-3 text-sm text-slate-700 font-mono resize-none focus:ring-2 focus:ring-indigo-500 outline-none leading-relaxed"
                  value={extractedText}
